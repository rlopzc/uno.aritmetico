...
public class ScreenCrearPartida implements Screen {
    ...
    public Boton namePlayer, nombre_del_juego, btnOK, btnAtras, btnJuego;
    ...
    public void render(float delta) {
        ...
        if (nombre_del_juego.meTocaste()) {
            Gdx.input.setOnscreenKeyboardVisible(true);
            System.out.println("nombre_del_juego");
    ...
    public void show() {
        ...
        if (!BluetoothSingleton.getInstance().bluetoothManager.EstadoAdapter()) {
    ...
    private void dibujar_botones_en_pantalla() {
        batch = AtsUtil.batch;
        nombre_del_juego = new Boton(null, 9.8f, 8.3f, 6.0f, 0.8f, 0);
